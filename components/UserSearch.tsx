...
import { InlineSpinnner } from "./LoadingSpinner";
function UserSearch({
    onSelectUser,
    placeholder = "Search",
    className,
    ...
    const { user } = useUser();
    // chercher les utilisateurs qui sont connectés au moment de la recherche
                                     ...
                                     <div className="flex items-center space-x-3">
                                        ...
                                        <div className="relative">
                                            <Image 
                                                ...
                                                width={40}
                                                height={40}
                                                className="h-10 rounded-full object-cover ring-2 ring-border"
                                            />
                                        </div>
