"use client";
import { InlineSpinnner } from "@/components/LoadingSpinner";
...
function VideoCall(){
    ...
    if(callingState === CallingState.RECONNECTING){
        return (
            <StatusCard 
                title="Reconnecting..."
                description="Connection lost, attemptig to reconnect."
            ...
            <div className="absolute inset-0 flex items-center justify-center bg-black/50 backdrop-blur-sm">
                <div className="bg-white rounded-2xl p-8 max-w-lg mx-4 shadow-2xl">
                    <div className="text-center space-y-6">
                        <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center items-center mx-auto">
